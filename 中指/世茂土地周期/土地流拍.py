...
df_all_data = df_all_data[["年","月","周","地块名称","城市","用地性质","区县","出让方式","建设用地面积(㎡)","规划建筑面积(㎡)","容积率","截止日期","起始价(万元)","土地星级","城市能级"]]
df_all_data.to_excel("data/房企拿地/土地流拍.xlsx", index=False)

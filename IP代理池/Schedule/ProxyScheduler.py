...
def runScheduler():
    ...
    # 付费ip
    scheduler.add_job(rawProxyScheduler, 'interval', seconds=11, id="raw_proxy_check", name="raw_proxy定时采集")
    scheduler.add_job(usefulProxyScheduler, 'interval', seconds=15, id="useful_proxy_check", name="useful_proxy定时检查")

...
class GetFreeProxy(object):
    ...
    @staticmethod
    def freeProxy_xdl():
        url = "http://api.xdaili.cn/xdaili-api//privateProxy/applyStaticProxy?spiderId=0c2bbe2a64db4931a27168a3f4ed2b6d&returnType=2&count=1"
        html = requests.get(url).json()
        print(html)
        if html["ERRORCODE"] in ["10036", "10038", "10055"]:
            print("提取过快,请至少10秒提取一次")
        if html["ERRORCODE"] == "10001":
            print("系统繁忙,请联系客服")
    ...
    @staticmethod
    def freeProxy_mg():
            url = "http://piping.mogumiao.com/proxy/api/get_ip_bs?appKey=bac475add829412793757fb8b9a67ff2&count=5&expiryDate=0&format=1&newLine=1"
            # url = "http://mvip.piping.mogumiao.com/proxy/api/get_ip_bs?appKey=0d3abb964bfe456ca633e9c53ccdd964&count=5&expiryDate=0&format=1&newLine=2"
            html = requests.get(url).json()
            print(html)
            if html["code"] == '3001':
                print("提取过快,请至少10秒提取一次")
